  ...
  return (
    <div className='searchDiv grid gap-10 bg-greyIsh rounded-[10px] p-[3rem]'>
      <form action="">
        ...
        <div className='firstDiv flex justify-beween items-center rounded-[8px] gap-[10px] bg-white p-5 shadow-greyIsh-700'>
        ...
        <div className='flex gap-2 items-center'>
          ...
          <input type="text" className='bg-transparent text-blue-500
          focus:outline-none w-[100%]' placeholder='Search Location...'/>
          <AiOutlineCloseCircle className='text-[30px] text-[#a5a6a6] hover:text-textColor icon'/>
        ...
        <div className='secDiv flex items-center gap-10 justify-center'>
          ...
          <span className='text-[#a1a1a] cursor-pointer'>Clear All</span>
        </div>
