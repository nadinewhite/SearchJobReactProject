  ...
  return (
    ...
    grid-cols-5 m-auto items-center justify-center'>
      <div>
        ...
        <p className='text-white pb-[13px] opacity-70 leading'>We always make our seekers and companies find the best jobs and employers find the best candidates.</p>
      </div>
      ...
      <div className='grid'>
        ...
        <div>
          ...
          Nadinetarh@gmail.com

          </small>
          <div className='icons flex gap-4  py-[1rem]'>
            <AiFillInstagram className=' bg-white p-[18px] h-[50px] w-[50px] rounded-full icon
            text-blueColor'/>
             <BsFacebook className=' bg-white p-[18px] h-[50px]  w-[50px] rounded-full icon
            text-blueColor'/>
             <AiOutlineTwitter className=' bg-white p-[18px] h-[50px] w-[50px] rounded-full icon
            text-blueColor'/>
          </div>
